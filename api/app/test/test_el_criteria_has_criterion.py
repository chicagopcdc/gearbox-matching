...
def test_el_criteria_has_criterion_info(el_criteria_has_criterionA, el_criteria_has_criterionB, app, session):
    for echc in [el_criteria_has_criterionA.as_dict(), el_criteria_has_criterionB.as_dict()]:
        with app.test_request_context("/el_criteria_has_criterion/{}-{}".format(echc['criterion_id'], echc['eligibility_criteria_id']), method="GET"):
            pid = "{}-{}".format(echc['criterion_id'], echc['eligibility_criteria_id'])
            response = ElCriteriaHasCriterionInfo().get(pid)
            assert pid == "{}-{}".format(response['criterion_id'], response['eligibility_criteria_id'])
...
def test_update_el_criteria_has_criterion(el_criteria_has_criterionA, el_criteria_has_criterionB, app, session):
    ...
    pidA = "{}-{}".format(el_criteria_has_criterionA_dict['criterion_id'], el_criteria_has_criterionA_dict['eligibility_criteria_id'])
