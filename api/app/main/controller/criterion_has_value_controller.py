...
class CriterionHasValueInfo(Resource):
    ...
    def get(self, public_id):
        ...
        criterion_has_value = CriterionHasValueService.get_a_criterion_has_value(data)
...
class Create(Resource):
    ...
    def post(self):
        ...
        try:
            response = CriterionHasValueService.save_new_criterion_has_value(new_criterion_has_value_dict)
            return response
...
class Update(Resource):
    ...
    def put(self, public_id):
        ...
        #retrieve the criterion_has_value to be updated
        pid = public_id.split('-')
        pid_data = {
            'value_id': pid[0],
            'criterion_id': pid[1],
        }
        criterion_has_value = CriterionHasValueService.get_a_criterion_has_value(pid_data)
        if not criterion_has_value:
            api.abort(404, message="criterion_has_value '{}' not found".format(public_id))
