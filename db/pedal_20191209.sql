...
CREATE TABLE IF NOT EXISTS `pedal_dev_v_0`.`criterion_has_value` (
  ...
  `elegibility_criteria_id` INT NOT NULL,
  `arm_id` INT NOT NULL,
  PRIMARY KEY (`value_id`, `criterion_id`, `elegibility_criteria_id`, `arm_id`),
  INDEX `fk_criterion_has_value_el_criteria_has_criterion1_idx` (`criterion_id` ASC, `elegibility_criteria_id` ASC, `arm_id` ASC),
  CONSTRAINT `fk_criterion_has_value_value1`
    FOREIGN KEY (`value_id`)
    REFERENCES `pedal_dev_v_0`.`value` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_criterion_has_value_el_criteria_has_criterion1`
    FOREIGN KEY (`criterion_id` , `elegibility_criteria_id` , `arm_id`)
    REFERENCES `pedal_dev_v_0`.`el_criteria_has_criterion` (`criterion_id` , `elegibility_criteria_id` , `arm_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
