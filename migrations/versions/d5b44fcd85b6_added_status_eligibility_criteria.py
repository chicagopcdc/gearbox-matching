...
def upgrade():
    ...
    eligibilityCriteriaStatus = postgresql.ENUM('NEW','ACTIVE','IN_PROCESS','INACTIVE',name='eligibilityCriteriaStatus')
    eligibilityCriteriaStatus.create(op.get_bind())
    op.add_column('eligibility_criteria', sa.Column('status', postgresql.ENUM('NEW', 'ACTIVE', 'IN_PROCESS', 'INACTIVE', name='eligibilityCriteriaStatus'), nullable=False))
