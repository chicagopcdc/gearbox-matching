...
def upgrade():
    ...
    op.add_column('eligibility_criteria', sa.Column('status', postgresql.ENUM('NEW', 'ACTIVE', 'IN_PROCESS', 'INACTIVE', 'CRITERIA_ADJUDICATION', 'ECHC_ADJUDICATION',name='eligibilityCriteriaStatus'), nullable=False))
