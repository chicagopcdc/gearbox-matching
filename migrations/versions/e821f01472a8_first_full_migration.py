...
Revision ID: e821f01472a8
Revises: 
Create Date: 2022-01-12 22:52:40.477692
...
def upgrade():
    ...
    sa.Column('study_version_id', sa.Integer(), nullable=False),
    sa.Column('algorithm_engine_id', sa.Integer(), nullable=False),
    sa.Column('start_date', sa.DateTime(), nullable=True),
    sa.Column('active', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['algorithm_engine_id'], ['algorithm_engine.id'], ),
    sa.ForeignKeyConstraint(['study_version_id'], ['study_version.id'], ),
    sa.PrimaryKeyConstraint('study_version_id', 'algorithm_engine_id')
    )
