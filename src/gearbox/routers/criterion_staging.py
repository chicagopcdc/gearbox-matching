...
@mod.get("/criterion-staging/{eligibility_criteria_id}", response_model=List[CriterionStaging], status_code=status.HTTP_200_OK, dependencies=[ Depends(auth.authenticate), Depends(admin_required)])
